...
namespace AspJWTAuth.Controllers
{
	...
	public class RolesController : ControllerBase
	{
        ...
        public RolesController(RoleManager<IdentityRole> roleManager, UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, IConfiguration configuration, IEmailSender emailSender)
		{
        ...
        public async Task<IActionResult> AssignRoleToUserByEmail(UserRole userRole) //string email, string roleName
        {
